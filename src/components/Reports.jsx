...
import {
  ...
  FileText, Filter, ArrowRight, Target, Layers, CheckCircle2,
  Briefcase, History
} from 'lucide-react';
    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="premium-card bg-gradient-to-br from-green-500/10 to-transparent border-green-500/20">
          <h3 className="text-sm font-medium text-gray-500 mb-2 flex items-center gap-2"><span className="text-lg font-bold text-green-500">₺</span> Bütçe Gerçekleşme</h3>
